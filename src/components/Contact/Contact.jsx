    ...
    <div className="flex justify-center mt-35 ">
      <div className="bg-green-200 rounded-xl h-150 w-190">
        ...
        <form onSubmit={handleSubmit}>
          ...
          <div className="flex justify-center mt-8">
            <div class="relative z-0 w-150">
              <textarea type="text" value={formData.msg} onChange={(e) => setFormData({
                  ...formData, msg:e.target.value
              })}
          ...
          <div className="flex justify-center mt-10">
            <button onClick={handleNavigate} className="pr-4 rounded-xl pl-4 pt-2 pb-2 text-white bg-green-500">Submit
            </button>
          </div>
        </form>
